...
row.names(s3_s4_counts) = c(names(s3_s4_counts)[1:20],"NA")

s4_s5_counts = as.data.frame.matrix(table(values(s4),
                                          values(s5), useNA = "always")*0.0625)
row.names(s4_s5_counts) = c(names(s4_s5_counts)[1:20],"NA")
...
s3_s6_counts = as.data.frame.matrix(table(values(s3),
                                          values(s6), useNA = "always")*0.0625)
row.names(s3_s6_counts) = c(names(s3_s6_counts)[1:20],"NA")
...
s3_s4_addreg = read.csv("D:/work9seea/5_extension3/data_tables/3_matriz_cambios_s3_s4_wmask_AdicionesRegresiones.csv",header=TRUE,
                        row.names = 1)
s4_s5_addreg = read.csv("D:/work9seea/5_extension3/data_tables/3_matriz_cambios_s4_s5_wmask_AdicionesRegresiones.csv",header=TRUE,
                        row.names = 1)
s5_s6_addreg = read.csv("D:/work9seea/5_extension3/data_tables/3_matriz_cambios_s5_s6_wmask_AdicionesRegresiones.csv",header=TRUE,
                        row.names = 1)
s3_s6_addreg = read.csv("D:/work9seea/5_extension3/data_tables/3_matriz_cambios_s3_s6_wmask_AdicionesRegresiones.csv",header=TRUE,
                        row.names = 1)
...
s3_s4_final = final_accountingw(allcounts,"s3","s4", s3_s4_addreg, n=5, labels = labels)
s4_s5_final = final_accountingw(allcounts,"s4","s5", s4_s5_addreg, n=4, labels = labels)
s5_s6_final = final_accountingw(allcounts,"s5","s6", s5_s6_addreg, n=3, labels = labels)
s3_s6_final = final_accountingw(allcounts,"s3","s6", s3_s6_addreg, n=12, labels = labels)

write.csv(s3_s4_final,"D:/work9seea/5_extension3/data_tablesw/4_s3_s4_wmask_finalaccounting_w.csv",row.names = TRUE)
write.csv(s4_s5_final,"D:/work9seea/5_extension3/data_tablesw/4_s4_s5_wmask_finalaccounting_w.csv",row.names = TRUE)
write.csv(s5_s6_final,"D:/work9seea/5_extension3/data_tablesw/4_s5_s6_wmask_finalaccounting_w.csv",row.names = TRUE)
write.csv(s3_s6_final,"D:/work9seea/5_extension3/data_tablesw/4_s3_s6_wmask_finalaccounting_w.csv",row.names = TRUE)
